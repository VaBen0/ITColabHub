...
import ru.dvteam.itcollabhub.databinding.FragmentAddTaskForParticipantBinding;
import ru.dvteam.itcollabhub.retrofit.PostDatas;
import ru.dvteam.itcollabhub.view.projectmenusviews.activities.tasks.PartisipantTasks;

public class AddTaskForParticipant extends Fragment {

    FragmentAddTaskForParticipantBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAddTaskForParticipantBinding.inflate(inflater);

        PartisipantTasks partisipantTasks = (PartisipantTasks) getActivity();
