...
import ru.dvteam.itcollabhub.databinding.FragmentPeoplesWithRolesBinding;
...
public class PeoplesWithRolesFragment extends Fragment {

    FragmentPeoplesWithRolesBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentPeoplesWithRolesBinding.inflate(inflater);
        RolesActivity rolesActivity = (RolesActivity) getActivity();

        binding.list.setLayoutManager(new LinearLayoutManager(getContext()));

        viewModel.getPeoplesWithRole().observe(getViewLifecycleOwner(), participantWithRoles -> {
