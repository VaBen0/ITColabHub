...
import ru.dvteam.itcollabhub.databinding.FragmentEditMainRoleBinding;
import ru.dvteam.itcollabhub.viewmodel.projectmenusviewmodels.EditRoleViewModel;


public class EditMainRoleFragment extends Fragment {

    FragmentEditMainRoleBinding binding;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        chooseRoles = instantiate(getContext(), EditChooseRolesForTasksFragment.class.getName());
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        binding = FragmentEditMainRoleBinding.inflate(inflater);

        EditRoleActivity rolesActivity = (EditRoleActivity) getActivity();
