...
import ru.dvteam.itcollabhub.databinding.FragmentEditPeoplesWithoutRolesBinding;
import ru.dvteam.itcollabhub.viewmodel.projectmenusviewmodels.EditRoleViewModel;

public class EditPeoplesWithoutRolesFragment extends Fragment {

    FragmentEditPeoplesWithoutRolesBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentEditPeoplesWithoutRolesBinding.inflate(inflater);
