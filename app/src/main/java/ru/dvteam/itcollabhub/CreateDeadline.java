...
import ru.dvteam.itcollabhub.databinding.ActivityCreateDeadlineBinding;
...
public class CreateDeadline extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCreateDeadlineBinding.inflate(getLayoutInflater());
                    ...
                    if(android.os.Build.VERSION.SDK_INT >= 33) {
                        ...
                        addImg.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                arr.setVisibility(View.GONE);
                                Img.setVisibility(View.VISIBLE);
                                if (ContextCompat.checkSelfPermission(CreateDeadline.this, android.Manifest.permission.READ_EXTERNAL_STORAGE)
                                        != PackageManager.PERMISSION_GRANTED) {
                                    ActivityCompat.requestPermissions(CreateDeadline.this,
        ...
        binding.uploadTask.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(binding.taskName.getText().toString().isEmpty()){
                    Toast.makeText(CreateDeadline.this, "Дайте название заданию", Toast.LENGTH_SHORT).show();
                }else{
                    ...
                    if(count > 0) {
                        for (int i = 0; i < type.size(); i++) {
                            ...
                            if (type.get(i).equals("1")) {
                                ...
                                if (text.getText().toString().isEmpty()) {
                                    Toast.makeText(CreateDeadline.this, "Нет текств", Toast.LENGTH_SHORT).show();
                                    enter = false;
                                    break;
                                }
                            ...
                            if (type.get(i).equals("2")) {
                                ...
                                if (linkTitle.getText().toString().isEmpty()) {
                                    Toast.makeText(CreateDeadline.this, "Нет названия ссылки", Toast.LENGTH_SHORT).show();
                                    enter = false;
                                    break;
                                }
                                EditText link = custom.findViewById(R.id.link_main);
                                if (link.getText().toString().isEmpty()) {
                                    Toast.makeText(CreateDeadline.this, "Нет ссылки", Toast.LENGTH_SHORT).show();
                                    enter = false;
                                    break;
                                }
                            ...
                            if (type.get(i).equals("4")) {
                                ...
                                if (linkTitle.getText().toString().isEmpty()) {
                                    Toast.makeText(CreateDeadline.this, "Нет названия ссылки на Ютуб", Toast.LENGTH_SHORT).show();
                                    enter = false;
                                    break;
                                }
                                EditText link = custom.findViewById(R.id.link);
                                if (link.getText().toString().isEmpty()) {
                                    Toast.makeText(CreateDeadline.this, "Нет ссылки на Ютуб", Toast.LENGTH_SHORT).show();
                                    enter = false;
                                    break;
                                }
                                String s = linkTitle.getText().toString() + "\uD83D\uDD70" + link.getText().toString();
                            ...
                            if (type.get(i).equals("3")) {
                                if(del.get(imgCount) == 1) {
                                    ...
                                    if (imgTitle.getText().toString().isEmpty()) {
                                        Toast.makeText(CreateDeadline.this, "Нет названия изображения", Toast.LENGTH_SHORT).show();
                                        enter = false;
                                        break;
                                    }
                                    if (mediaPaths.get(imgCount).equals("")) {
                                        Toast.makeText(CreateDeadline.this, "Нет изображения", Toast.LENGTH_SHORT).show();
                                        enter = false;
                                        break;
                                    }
                        ...
                        if (enter) {
                            Intent intent = new Intent(CreateDeadline.this, CreateDedline2.class);
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions,
        ...
        if (requestCode == MY_PERMISSIONS_REQUEST_READ_EXTERNAL_STORAGE) {
            if (grantResults.length > 0
                ...
                Toast.makeText(CreateDeadline.this, "You loser", Toast.LENGTH_LONG).show();
            }
        }
    }
                ...
                new ActivityResultCallback<ActivityResult>() {
                    ...
                    public void onActivityResult(ActivityResult result) {
                        try{
                            ...
                            Toast.makeText(CreateDeadline.this, "LOSER", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
        );
    ...
    private void setActivityFormat(int score){
        if(score < 100){
            ...
            getWindow().setStatusBarColor(ContextCompat.getColor(CreateDeadline.this,R.color.blue));
        }
        else if(score < 300){
            binding.bguser.setBackgroundResource(R.drawable.gradient_green);
            getWindow().setStatusBarColor(ContextCompat.getColor(CreateDeadline.this,R.color.green));
        }
        else if(score < 1000){
            binding.bguser.setBackgroundResource(R.drawable.gradient_brown);
            getWindow().setStatusBarColor(ContextCompat.getColor(CreateDeadline.this,R.color.brown));
        }
        else if(score < 2500){
            binding.bguser.setBackgroundResource(R.drawable.gradient_light_gray);
            getWindow().setStatusBarColor(ContextCompat.getColor(CreateDeadline.this,R.color.light_gray));
        }
        else if(score < 7000){
            binding.bguser.setBackgroundResource(R.drawable.gradient_ohra);
            getWindow().setStatusBarColor(ContextCompat.getColor(CreateDeadline.this,R.color.ohra));
        }
        else if(score < 17000){
            binding.bguser.setBackgroundResource(R.drawable.gradient_red);
            getWindow().setStatusBarColor(ContextCompat.getColor(CreateDeadline.this,R.color.red));
        }
        else if(score < 30000) {
            binding.bguser.setBackgroundResource(R.drawable.gradient_orange);
            getWindow().setStatusBarColor(ContextCompat.getColor(CreateDeadline.this, R.color.orange));
        }
        else if(score < 50000){
            binding.bguser.setBackgroundResource(R.drawable.gradient_violete);
            getWindow().setStatusBarColor(ContextCompat.getColor(CreateDeadline.this,R.color.violete));
        }
        else{
            binding.bguser.setBackgroundResource(R.drawable.gradient_blue_green);
            getWindow().setStatusBarColor(ContextCompat.getColor(CreateDeadline.this,R.color.main_green));
        }
    }
